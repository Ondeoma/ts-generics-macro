...
export const DiagnosticMessage = {
  DebugMessage: {
    ...
    messageText: `This is debug message.`,
    code: 23999,
  },
  ...
  */
  ...
  IdentifierWithNoSymbol: {
    category: ts.DiagnosticCategory.Error,
    messageText: `
      Symbol for the identifier in the macro definition must be available at call.
      This may be caused by macro generated by other preceeding transformers.
    `,
    code: 24103,
  },
  InaccessibleIdentifier: {
    category: ts.DiagnosticCategory.Error,
    messageText: `
      Macro uses an inaccessible identifier.
